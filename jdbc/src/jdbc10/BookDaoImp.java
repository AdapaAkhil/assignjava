...
public class BookDaoImp implements BookDao{
	...
	public List<Book> getAllBooks() {
		...
		Book tempbook;
		try {
			String get_all_query = "select * from bookstore";
	...
	public Book addBook(Book book) {
		// TODO Auto-generated method stub
		try {
			String add_query = "insert into bookstore(id,title,author,price) values(?,?,?,?)";
	...
	public Book deleteBook(int id) {
		...
		try {
			String delete_book_by_id = "delete from bookstore where id=?";
	...
	public Book updateBook(int id, Double price) {
		...
		try {
			String update_book_query = "update bookstore set price=? where id=?";
	...
	public Book getBookById(int id) {
		...
		Book book = null;
		try {
			String get_book_by_id = "select * from bookstore where id=?";
